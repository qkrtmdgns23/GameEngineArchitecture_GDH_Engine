...
namespace gdh_system {
	...
	Time::Time() :delta_time_(0)
	{
		...
		render_.per_frame = frame_info_.QuadPart / static_cast<long long>(DefinedFrame::kRender);
		logic_.per_frame = frame_info_.QuadPart / static_cast<long long>(DefinedFrame::kLogic);
	}
}	// namespace gdh_system
